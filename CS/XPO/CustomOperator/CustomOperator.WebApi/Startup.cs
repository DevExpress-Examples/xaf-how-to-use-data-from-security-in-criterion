...
using CustomOperator.WebApi.JWT;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafWebApi(builder => {
            ...
            builder.Modules
                .AddValidation()
                .Add<CustomOperator.Module.CustomOperatorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(CustomOperator.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(CustomOperator.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.CustomOperator";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "CustomOperator API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the CustomOperator.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CustomOperator WebApi v1");
            });
        }
        else {
